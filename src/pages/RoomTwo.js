...
const RoomTwo = () => {
  ...
  useEffect(() => {
    ...
    const ws = new WebSocket("ws://localhost:666/websocket/roomtwo");
    setSocket(ws);
    ws.onopen = () => {
    ...
    <>
      <Box>
        <Grid container>
          ...
          ></Grid>
          <Grid item xs={6}>
            <Box sx={{ height: "10vh", backgroundColor: "#22102D" }}> <Item sx={{ height: "10vh", backgroundColor: "#22102D", color: "white", fontSize: 30 }}> SALA 2 </Item> </Box>
